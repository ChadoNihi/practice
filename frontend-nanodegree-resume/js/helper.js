...
var HTMLwork = ['<div class="work-entry"></div>', '<a href="#">%data%', ' - %data%</a>', '<div class="date-text">%data%</div>', '<div class="location-text">%data%</div>', '<p><br>%data%</p>'];
/*
...
*/
var HTMLproject = ['<div class="project-entry"></div>', '<a href="#">%data%</a>', '<div class="date-text">%data%</div>', '<p><br>%data%</p>', '<img src="%data%">'];
/*
...
*/
var HTMLschool = ['<div class="education-entry"></div>', '<a href="#">%data%', ' -- %data%</a>', '<div class="date-text">%data%</div>', '<div class="location-text">%data%</div>', '<em><br>Major: %data%</em>'];
/*
...
*/
var HTMLonlineCourse = ['<div class="education-entry"></div>','<a href="#">%data%',' - %data%</a>','<div class="date-text">%data%</div>','<br><a href="#">%data%</a>'];
/*
